...
negamax(J, Etat, P, Pmax, [Coup, Val]):-
    ...
    loop_negamax(J,P,Pmax,Succ,ListCoups),
    meilleur(ListCoups,[Coup,Val1]),
    Val is -Val1.
...
loop_negamax(J,P,Pmax,[[Coup,Suiv]|Succ],[[Coup,Vsuiv]|Reste_Couples]) :-
	loop_negamax(J,P,Pmax,Succ,Reste_Couples), % on appel recusivemnt loop_negamax jusqu'a ce qu'on aie depilé tout les coup successeur de l'etat courrant possible
	adversaire(J,A),    % On met dans A l'adversaire de J
	Pnew is P+1,    % on augmente la profondeur de l'exploiration
